let time: number[] = [0,0,0,0]; 
let keyListening = false;
let timerInterval: any; 
let secondover: boolean = false; 
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function whenKeyDown (event: KeyboardEvent){
        let key = event.key;
...
function formatTimeFromTyped(time: number[], secondover: boolean) : string {
